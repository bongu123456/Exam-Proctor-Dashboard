          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              <label style={{
                ...
                gap: '8px',
                padding: '12px',
                background: role === 'student' ? 'rgba(124, 58, 237, 0.15)' : 'rgba(255,255,255,0.02)',
                border: `1px solid ${role === 'student' ? '#7c3aed' : 'rgba(255,255,255,0.08)'}`,
                borderRadius: '10px',
                cursor: 'pointer',
                fontSize: '14px',
                fontWeight: 600,
              ...
              <label style={{
                ...
                gap: '8px',
                padding: '12px',
                background: role === 'admin' ? 'rgba(124, 58, 237, 0.15)' : 'rgba(255,255,255,0.02)',
                border: `1px solid ${role === 'admin' ? '#7c3aed' : 'rgba(255,255,255,0.08)'}`,
                borderRadius: '10px',
                cursor: 'pointer',
                fontSize: '14px',
                fontWeight: 600,
